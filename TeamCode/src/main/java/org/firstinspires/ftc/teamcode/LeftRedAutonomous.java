...
@Autonomous(name="LeftRedAutonomous", group="! State", preselectTeleOp="State TeleOp")
...
*/
        ...
        Trajectory traj1 = drive.trajectoryBuilder(startPose)
                ...
                .splineToSplineHeading(new Pose2d(26.25, 12, Math.toRadians(-100)), Math.toRadians(-120),
        ...
        Trajectory traj9 = drive.trajectoryBuilder(traj8.end())
                ...
                .lineToSplineHeading(new Pose2d(placeX - 1, placeY - 1, Math.toRadians(0)))
                .addSpatialMarker(new Vector2d(50, 10), () -> {
                    TurnTablePos(TURNTABLE_RIGHT, 0.2);
                })
